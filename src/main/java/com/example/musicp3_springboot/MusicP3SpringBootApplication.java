package com.example.musicp3_springboot;
...
public class MusicP3SpringBootApplication {

    public static void main(String[] args) {

        ApplicationContext context = SpringApplication.run(MusicP3SpringBootApplication.class, args);
